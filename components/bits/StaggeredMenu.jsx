...
export const StaggeredMenu = ({
  ...
  return (
    <div
      className={`sm-scope absolute z-40 ${open ? "w-full h-full" : "h-0"} ${isFixed ? 'fixed top-0 left-0 w-screen h-[100dvh] overflow-hidden visible' : ''}`}>
      <div
        className={
          (className ? className + ' ' : '') + 'staggered-menu-wrapper pointer-events-none relative w-full h-full bg-transparent'
        }
        ...
        <div
          className={`staggered-menu-header absolute top-0 left-0 !w-max flex items-center justify-between bg-transparent pointer-events-none z-20`}
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer text-[#e9e9ef] font-medium leading-none overflow-visible pointer-events-auto ${open ? "z-50 text-black-500" : ""}`}
        ...
        <aside
          ...
          ref={panelRef}
          className={`staggered-menu-panel absolute top-0 right-0 h-[100dvh] bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto  ${open ? "visible" : "invisible"}`}
