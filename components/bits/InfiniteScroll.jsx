...
export default function InfiniteScroll({
  ...
  return (
    <div
      ...
      style={{maxHeight}}>
      <div
        className="absolute top-0 left-0 w-full h-1/4 bg-gradient-to-b from-black to-transparent z-10 pointer-events-none"></div>
      <div
        className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t from-black to-transparent z-10 pointer-events-none"></div>
      <div
        className="flex flex-col overscroll-contain px-[.5vw] cursor-grab origin-center"
        ref={containerRef}
        style={{
          width,
